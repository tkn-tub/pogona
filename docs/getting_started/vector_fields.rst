...
In order to run the example scenarios, make sure to have a copy of our `OpenFOAM cases repository <https://github.com/tkn-tub/pogona/pogona-openfoam-cases>`_ and that the relevant OpenFOAM simulations have completed successfully.
